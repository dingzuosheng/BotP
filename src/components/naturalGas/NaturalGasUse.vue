...
<div class="main">
    <div class="content">
        ...
        <div v-if="!this.show">
            <div>
                Natural Gas Use: {{ Math.ceil(this.naturalGasUse) }} Exajoules
            </div>
                    ...
                    <div class="formula">
                        ...
                        <div>
                            <div class="row-formula">
                                <span>Use Rate</span> <span>= {{ naturalGasUseRate }}</span> 
                                <span>
                                    <button @click="add">+0.01</button>
                                    <input type="range" min="0.01" max="1.00" step="0.01" v-model="useRate" @change="changeNaturalGasUseRate" />
