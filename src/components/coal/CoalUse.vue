                    ...
                    <div class="formula">
                        ...
                        <div>
                            <div class="row-formula">
                                <span>Use Rate</span> <span>= {{ coalUserate }}</span> 
                                <span>
                                    <button @click="add">+0.01</button>
                                    <input type="range" min="0.01" max="1.00" step="0.01" v-model="userate" @change="changeCoalUserate" />
    ...
    methods: {
        ...
        draw(){
            ...
            for(let i = 0; i < labels.length; i++){
                coalUses.push(Math.ceil(JSON.parse(localStorage.getItem(labels[i])).coalUse*10)/10)
