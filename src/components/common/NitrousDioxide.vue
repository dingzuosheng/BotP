                ...
                <div class="formula">
                    ...
                    <div class="formula">
                        <div class="row-formula">
                            <span>C1</span> <span>= {{ c1 }}</span> <span><input type="range" min="10" max="1000" step="10" v-model="quantity1" @change="changeC1Quanty" /> (tons/Exajoule)</span>
                        </div>
                        <div class="row-formula">
                            <span>C2</span> <span>= {{ c2 }}</span> <span><input type="range" min="100" max="500" step="1" v-model="quantity2" @change="changeC2Quanty" /> (tons/Exajoule)</span>
                        </div>
                        <div class="row-formula">
