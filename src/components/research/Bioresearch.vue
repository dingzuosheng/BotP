        ...
        <div class="content">
            ...
            <div v-if="!this.show">
                ...
                <div class="range">
                    ...
                    <input type="range" min="0" max="0.08" step="0.01" v-model="percent" @change="changeBioResearchSusidyPercent"/><!--value is string-->
                    <div>
                        <p class="text">
    ...
    methods:{
        ...
        draw(){
            ...
            for(let i = 0; i < labels.length; i++){
                coalUses.push(Math.ceil(JSON.parse(localStorage.getItem(labels[i])).bioResearchBudget/Math.pow(10,9)*100)/100)
                console.log(labels[i],localStorage.key(i))
            }
            const dataset = {
                label:'Bio Research Budget(Unit: billion dollars)',
